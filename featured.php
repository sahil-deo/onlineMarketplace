...
<body>
    <header>
        ...
        <div class="headeroptions">
            ...
            <div class="headeroption  currentpage"><a href="featured.php">Featured</a></div>
            <div class="headeroption"><a href="toprated.php">Top Rated</a></div>
        </div>
    </header>
    <main>
        ...
        <div class="container">
        <?php
            require_once("inc/spawnFeatured.php");
        ?>
